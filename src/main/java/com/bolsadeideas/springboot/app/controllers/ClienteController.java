...
public class ClienteController {
	...
	public String listar(@RequestParam(name = "page", defaultValue = "0") int page, Model model,
		...
		if(request.isUserInRole("ROLE_ADMIN")){
			logger.info("Forma usando  request hola ".concat(authentication.getName()).concat(" tienes acceso!"));
		}else{
			logger.info("Forma usando  request hola ".concat(authentication.getName()).concat(" NO tienes acceso!"));
		}
